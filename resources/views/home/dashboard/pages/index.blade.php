<div class="p-5 col-span-full md:col-span-7 xl:col-span-8 xl:p-10 hsh-card">
    <div class="flex flex-row items-center justify-between mb-10">
       <h2 class="text-3xl font-bold text-slate-600 xl:text-4xl font-heading dark:text-white">Pages</h2>
       <a class="flex flex-row items-center button-primary big" href="/62fc743a4900bfdc627653c3/dashboard/pages/create"><span>Create new page</span></a>
    </div>
    <div class="flex flex-row flex-wrap items-center justify-between py-6 mb-4 border-b dark:border-slate-800">
        ...
        <div class="flex flex-row items-center w-full md:w-auto">
            <a target="_blank" class="flex flex-row items-center mr-2 button-transparent small text-blue-600" href="">
            ...
            <a class="mr-2 button-transparent small" href="/62fc743a4900bfdc627653c3/dashboard/pages/edit/about-me">Edit Page</a>
            <button class="button-transparent small hover:text-red-600" href="#">Delete</button>
        </div>
    </div>
    <div class="flex flex-row flex-wrap items-center justify-between py-6 mb-4 border-b dark:border-slate-800">
        <div class="flex-1 w-full mb-2 mr-4 md:w-auto md:mb-0">
        ...
        <div class="flex flex-row items-center w-full md:w-auto">
            ...
            <button class="mr-2 button-transparent small disabled tooltip-handle" data-title="You cannot edit this page" disabled="">Edit Page</button>
