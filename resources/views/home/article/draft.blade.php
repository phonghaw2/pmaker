                                ...
                                <div class="menu-float__content">
                                    <ul class="menu-float__filters">
                                        <li>
                                            ...
                                            Awards
                                            <svg class="ico-svg menu-float__arrow" viewBox="0 0 20 20" width="12"><use xlink:href="https://www.awwwards.com/assets/redesign/images/sprite-icons.svg#arrow-dd"></use></svg>
                                            </span>
                                        </li>
                                        <li>
                                            <span class="menu-float__filter js-menufloat-filter" data-id="filter-winners-award">
