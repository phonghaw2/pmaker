...
(function () {
    ...
    draftQuery.prototype.addToolbar = function () {
        ...
        parent.setAttribute("id", "toolbar-editor");
    ...
    draftQuery.prototype.renderToolbar = function () {
        let innerHTML = `
        <button type="button" data-command='h1' class='css-1pulk9m'>
        ...
        <button type="button" data-command='h2' class='css-1pulk9m'>
        ...
        <button type="button" data-command='h3' class='css-1pulk9m'>
        ...
        <button type="button" data-command='bold' class='css-1pulk9m'>
        ...
        <button type="button" data-command='italic' class='css-1pulk9m'>
        ...
        <button type="button" data-command='strike' class='css-1pulk9m'>
        ...
        <button type="button" data-command='inline-code' class='css-1pulk9m'>
        ...
        <button type="button" data-command='link' class='css-1pulk9m'>
